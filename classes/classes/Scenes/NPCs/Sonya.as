	...
	*/
		public function Sonya()
		{
			if (game.flags[kFLAGS.SONYA_TALKED_ABOUT_HER] >= 1) {
				...
				this.long = "The glacial bull is twelve feet tall, much taller and muscular than any other bull you've seen before. Additionally it seems to be heavy corrupted having much less human traits than other minotaurs you meet. Weirdly he seems to have his chest covered by piece of cloth too in addition to typically used by his brothers loincloth, but that not distracts you from the pair of large hammers it wields.";
			}
