...
private function evangelineAppearance():void {
	...
	else if (flags[kFLAGS.EVANGELINE_LVL_UP] >= 5) outputText("hair are ass-length along with breasts that could easily fill an E-cup bra, jiggly ass and curvy hips is quite a change that resulted from her drinking bimbo liquer personally modified by her.\n\n");
