	...
	*/	public function spellCostChargeWeaponMightChargeArmorBlink():Number {
		...
		*/
		...
		public function Evangeline3()
		{
			...
			if (flags[kFLAGS.EVANGELINE_LVL_UP] == 12) {
				this.long = "You are currently fighting Evangeline, which is an eight feet tall cow-succubus hybrid with traces of taking in the past bimbo liquer. She's wearing lusty maiden's armor and using inscribed spellblade to attack.";
			...
			if (flags[kFLAGS.EVANGELINE_LVL_UP] == 14) {
				this.long = "You are currently fighting Evangeline, which is an eight feet tall cow-succubus-kitsune hybrid with traces of taking in the past bimbo liquer. She's wearing lusty maiden's armor and using inscribed spellblade to attack.";
				createBreastRow(Appearance.breastCupInverse("F"));
				this.tallness = 96;
				this.skin.setBaseOnly({});
				this.hips.type = Hips.RATING_FERTILE + 3;//hips.type = 18
			...
			if (flags[kFLAGS.EVANGELINE_LVL_UP] == 16) {
				this.long = "You are currently fighting Evangeline, which is an eight feet tall multiracial chimera with traces of taking in the past bimbo liquer. She's wearing lusty maiden's armor and using inscribed spellblade to attack.";
				createBreastRow(Appearance.breastCupInverse("F"));
				this.tallness = 96;
				this.skin.setBaseOnly({});
				this.hips.type = Hips.RATING_FERTILE + 3;//hips.type = 18
