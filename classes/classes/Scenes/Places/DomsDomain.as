...
public class DomsDomain extends BaseContent implements SaveableState, TimeAwareInterface {
    ...
    public function EnterTheDomain():void {
        ...
        menu();
        addButton(7, "Leave", camp.returnToCampUseOneHour);
        addButton(12, "Restaraunt", FoodHall);
        addButton(13, "D.Dullahan", DaintyDullahanEnter);
    }
    ...
    public function FoodHall():void {
        ...
        if (EmeraldState == 0) {
            ...
            outputText("“[Master] [Player], I presume?” She bites her lip, shuddering slightly. “My name is Emerald, but please, call me Em. If you want anything in the restaurant, please talk to me.” A passing demon slaps her on the ass, and she winces.   ");
        ...
        menu();
        addButton(1, "Nolan", NolanTalk);
        if (ZetazState  !=3) {
            addButton(2, "Zetaz", ZetazTalk);
        }
        addButton(3, "Meal", GetFood);
        addButton(7, "StripClub", StripClub);
        addButton(11, "Brewery", BreweryEnter);
        addButton(12, "Entrance", EnterTheDomain);
        addButton(13, "Merchant", Jabbasplace);
    ...
    private function StripClub():void {
        ...
        if (whosincharge == 0) {
            ...
            menu();
            addButton(7, "Throne", SitonYourThrone);
            addButton(11, "Toilets", CumtoiletsEnter);
            addButton(12, "FoodHall", FoodHall);
            addButton(13, "Brothel", BrothelEnter);
        }
        if (whosincharge == 1) {
            //6:00-18:00
...
if (MeilaState == 0) {
    ...
    outputText("");
    menu();
    addButton(1, "Appearance", MeilaCheckOut);
    addButton(2, "Talk", MeilaTalk);
    addButton(3, "Sex", MeilaSexMenu);
    addButton(4, "D.Dull", MeilaBusiness);
        }
    }
    ...
    private function MeilaTalk():void {
        ...
        if (MeilaTrust > 30 && MeilaTrust < 50) {
            ...
            outputText("");
            menu();
            addButton(1, "History", MeilaTalkHistory);
            addButton(2, "Others", MeilaTalkOthers);
            if (MeilaTrust > 60) {
                addButton(3, "Betrayal", MeilaTurnOnCeraph);
            }
        }
        if (MeilaTrust > 50) {
            ...
            if (MeilaTrust > 60) {
                ...
                addButtonDisabled(3, "Betrayal", "Maybe if Meila trusted you more?")
            }
            }
        }
...
doNext(FoodHall);
    ...
    private function Jabbasplace():void {
        ...
        if (JabbaState == 0) {
            ...
            outputText("“Ah.” He nods respectfully. “You must be [Player]. That’s right, not [Master], I’m not one of Ceraph’s pets.” He chuckles. “Go help with the moving, my dears. You’ll know when I want you back.” They simply nod, the cords detaching from their collars. Their glazed eyes focus, they fly away, and he gives you his full attention. ");
    ...
    private function DronifyWhore():void {
        ...
        outputText("“Very good.” Those words send a sudden burst of pleasure through you. (If pussy) Your clit vibrates, your labia shaking as if his words were a cock, right at your entrance. (If both) and (If dick) the thong can’t hide your erection. His words wrap around your [cock] like a warm, slick vice. ");
        outputText("You…Want More…");
        outputText("“That’s it…Let the collar take control. Rest, [Player], let yourself drown in the pleasure.” Your mouth’s moving, the collar’s warmth spreading. Finally, your eyelids sink, half-covering your vision…Not that you care. You’re so warm, deliciously swathed in the collar’s embrace.");
        outputText("Master is very happy. You move slowly towards him, and he brings one hand to your cheek. His touch is smooth, comforting…He’s saying something…But it doesn’t matter what. Your body knows what to do. Master’s got plans for you…and even the thought of disobeying sends a sliver of cold panic through your heart. \n" +
                "\n" +
                "Good.\n" +
                "\n" +
    ...
    private function CeraphTellOff():void {
        outputText("Is she fucking serious? Oh hell no, this will not stand. Angrily, you stomp towards the stage, pushing aside any demons in your way. When you finally reach the stage, you approach Ceraph, rage emanating from your eyes. It seems she’s only now realized that she has angered you. “Uh, [Master] [Player]? Is somethi-”");
        ...
        outputText("You toss Ceraph into the crowd, knocking over a few demons with her now fairly limp body. She struggles to breathe for a moment before finally speaking. “[Master] [Player]! I swear, I didn’t mean to-”");
