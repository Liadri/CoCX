...
public class LizanRogueScene extends BaseContent
	{
		...
		public function leaveLizan(pure:Boolean = false):void {
			...
			if (!pure) {
				...
				outputText("You tell the lizan you aren't up for any games. He shrugs, \"<i>Maybe next time then,</i>\" he says as he rummages around in his pack. When he finds what he's looking for he takes it out and tosses it towards you. You catch the small vial and read that it is labeled Reptilum. When you look up the scaly guy is nowhere to be seen. You head back to camp, smiling at the weird but friendly encounter.");
